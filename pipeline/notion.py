...
def write_local_enrichment(config: Config, page_id: str, title: str) -> None:
    """
    Write title to a Notion page and advance it to Enriched status.

    extracted_externals is now generated by the Claude pass alongside expanded_summary.
    Does NOT touch expanded_summary, extracted_externals, or raw_extraction fields.
    """
    import datetime
